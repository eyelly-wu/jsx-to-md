...
## 3. 初始化命令行配置文件
在命令行终端输入如下命令，[更多命令](https://github.com/eyelly-wu/jsx-to-md/blob/v0.11.4/docs/dist/COMMAND_LINE_zh-CN.md#2-命令)
```bash
npx jtm init
```
...
根据需求自行调整配置文件中的配置项，配置项的[说明](https://github.com/eyelly-wu/jsx-to-md/blob/v0.11.4/docs/dist/COMMAND_LINE_zh-CN.md)
