...
Enter the following command at the command line terminal, [More Commands](https://github.com/eyelly-wu/jsx-to-md/blob/v0.11.2/docs/dist/COMMAND_LINE.md#2-command)
```bash
npx jtm init
```
...
Adjust the configuration items in the configuration file according to the requirements [description](https://github.com/eyelly-wu/jsx-to-md/blob/v0.11.2/docs/dist/COMMAND_LINE.md)
